...
[TestFixture]
internal sealed class ExpressionBodiedMethodArrowTests : CodeFixVerifier
{
	[Test]
	...
	public void InvalidExpressionBodiedMethod()
	{
		...
		{
			Id = ExpressionBodiedMethodArrowAnalyzer.DiagnosticId,
	...
	protected override DiagnosticAnalyzer GetCSharpDiagnosticAnalyzer() => new ExpressionBodiedMethodArrowAnalyzer();

	protected override CodeFixProvider GetCSharpCodeFixProvider() => new ExpressionBodiedMethodArrowCodeFixProvider();
}
